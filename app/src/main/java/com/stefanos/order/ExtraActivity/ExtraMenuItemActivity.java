...
public class ExtraMenuItemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_extra_menu_item);
    }
    ...
    private void setUpRecyclerView() {
        ...
        extraAdapter = new ExtraAdapter(options);
        ...
        new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT) {
            ...
            public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
                ...
                extraAdapter.deleteItem(viewHolder.getAdapterPosition());
    ...
    private void setFloatingActionButtonMethod() {
        ...
        floatingActionButton = findViewById(R.id.addExtraButton);
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                alertDialogBuilder = new AlertDialog.Builder(ExtraMenuItemActivity.this);
                view = getLayoutInflater().inflate(R.layout.create_extra_dialog, null);
                alertDialogBuilder.setView(view);
                dialog = alertDialogBuilder.create();
                dialog.show();

                createNewExtraTextInputLayout = view.findViewById(R.id.createExtraMenuItemXml);
                createExtra = view.findViewById(R.id.createExtraXml);
                    ...
                    public void onClick(View view) {
                        ...
                        if (!createId.getText().toString().trim().isEmpty() &&
                            ...
                            DocumentReference newExtra = db.collection("store").document(storeName).
                                    collection("menuCategory").document(readPreferencesMenuCategory()).
                                    collection("menuItems").document(readPreferenceMenuItem()).
                                    collection(readPreferenceMenuItem()+"extra").document();
                            newExtra.set(exampleTry);


                            startActivity(new Intent(ExtraMenuItemActivity.this, ExtraMenuItemActivity.class));
    ...
    protected void onStart() {
        super.onStart();
        setUpRecyclerView();
        extraAdapter.startListening();
        toolbar=findViewById(R.id.toolbarExtraActivity);
